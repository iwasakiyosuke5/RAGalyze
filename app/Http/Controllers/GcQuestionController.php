...
class GcQuestionController extends Controller
{
    /**
    ...
    public function show(GcQuestion $gcQuestion)
    {
        // 
    }
     ...
     */
    public function edit(GcQuestion $gcQuestion)
    {
        //
    }
     ...
     */
    public function update(Request $request, GcQuestion $gcQuestion)
    {
        //
    }
     ...
     */
    public function destroy(GcQuestion $gcQuestion)
    {
        //
    }
    ...
    public function search(Request $request)
    {
        ...
        $fragments = GcResult::with('user')->get();   // データベースからすべてのフラグメントを取得
    ...
    try {    
        ...
        if ($response->successful()) {
            ...
            return redirect()->route('gcs.errorPage')->with('error', 'API Error: ' . $response->status());
        }
        ...
        // その他のリクエスト例外
        return redirect()->route('gcs.errorPage')->with('error', 'Request Error: ' . $e->getMessage());

    } catch (\Exception $e) {

        return redirect()->route('gcs.errorPage')->with('error', 'An unexpected error occurred: ' . $e->getMessage());
    }
