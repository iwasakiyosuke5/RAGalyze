    ...
    <div class="lg:w-full lg:flex px-3">
        ...
        <section class="lg:w-2/5 text-gray-900 body-font">
            <div class="container px-5 lg:py-40 py-12 mx-auto">
                <h1 class="ml-2 text-4xl"><span class="text-green-500 font-bold">R</span>egister GC Chromatogram</h1>
                <div class="ml-2 h-1 w-20 bg-green-500 rounded"></div>
                <br>
                <div class="container px-5 pt-16 mx-auto">
                    <div class="text-center">
                        <h1 class="ml-2 text-green-500"></h1>
                        ...
                        <form action="{{ route('convertGc.png') }}" method="POST" enctype="multipart/form-data" onsubmit="return handleFormSubmit()">
                            @csrf
                            <div class="file-input-container my-2">
                                <label for="file" class="text-2xl custom-file-label border-2 border-green-500 rounded py-2 px-3 cursor-pointer hover:bg-green-200">Click And Choose PNG:</label>
            ...
            <div class="container px-5 lg:py-auto py-12 mx-auto">
              <div class="flex items-center lg:w-4/5 mx-auto lg:border-t-0 border-t lg:pt-0 pt-5 pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
                <div class="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full bg-green-100 text-green-500 flex-shrink-0">
                    <div class="text-6xl fa-regular fa-circle-check" style="color: #29e01f;"></div>
                </div>
