                    ...
                    <div class="xl:w-3/5">
                        <div class="ml-12 mr-12">
                            <div class="card-body">
                                ...
                                <div class="text-gray-600 text-lg w-full p-2 bg-gray-50 rounded-lg border border-green-500">{!! $question !!}</div>
                            </div>
                        </div>
                        <br>
                        <div class="ml-12 mr-12">
                            <div class="card-body">
                                ...
                                <div class="text-gray-600 text-lg w-full p-2 bg-gray-50 rounded-lg border border-green-500">{!! $aiResponse !!}</div>
                                <div class="grid place-items-end">
                                    <a href="{{ route('gcQuestion') }}" class="rounded bg-sky-500 text-gray-50  hover:bg-sky-700 p-2 mt-1">Start Over</a>                                    
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="ml-12 mr-12">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('askAgainGc') }}" onsubmit="showSpinner()">
                                    @csrf
                                    <div class="form-group">
                                        <textarea class="pl-2 w-full min-h-40 rounded-lg border border-green-500 text-lg" type="text" id="followupQuestion" name="followupQuestion" required></textarea>
                                    </div>
