                ...
                <div>
                    <div class="flex flex-wrap w-full mb-10">
                        <div class="lg:w-1/3 w-full mb-6 lg:mb-0 lg:my-10">
                          <h1 class="sm:text-4xl text-2xl font-medium title-font px-2 mb-2 text-gray-900"><span class="text-green-500 font-bold">O</span>ur Records</h1>
                          <div class="h-1 w-20 bg-green-500 rounded ml-2"></div>
                        </div>
                        <div class="lg:w-2/3 w-full grid place-items-center">
                            <p class="px-auto text-lg leading-relaxed text-gray-500">On this page, you can track your GC analysis data with ease: 
                        ...
                        <div class="flex text-rap overflow-x-auto">
                            <div class="w-1/2 mb-4 flex justify-center ">
                                <div class="mx-auto pt-4">
                                    ...
                                    <select class="rounded-lg border border-green-500" id="yearSelect">
                        ...
                        <div>
                            ...
                            @if(Auth::user()->position == 'GL' || Auth::user()->position == 'GM')
                                <div class="ml-12">
                                    ...
                                    <select id="departmentSelect" class="rounded-lg text-sm border border-green-500" >
...
<script>
    $(document).ready(function() {
        ...
        function loadDepartmentCount(year) {
            $.ajax({
                url: "{{ route('api.departmentCountGc') }}",
                method: 'GET',
                data: { year: year },
