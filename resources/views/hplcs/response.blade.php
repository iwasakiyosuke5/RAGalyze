                ...
                <div class="xl:flex xl:w-full">
                    <div class="xl:w-3/5">
                        <div class="ml-12 mr-12">
                            <div class="card-body">
                                <h5 class="text-xl">Your Question :</h5>
                        ...
                        <div class="ml-12 mr-12">
                            <div class="card-body">
                                <h5  class="text-xl">AI Response :</h5>
                    ...
                    <div class="xl:w-2/5 border-l border-gray-200 xl:mt-0 mt-8">
                        <div class="xl:ml-4 ml-12 xl:mr-4 mr-12">
                            <h5 class="text-xl font-semibold mb-4 text-gray-800">Top Data Sources Used by AI for This Answer:</h5>
