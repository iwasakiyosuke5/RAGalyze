            ...
            <div class="flex w-full">
                <div class="w-1/3 border-r-2">
                    <div class="justify-center">
                        <div class="m-4">
                            <h1 class=" text-4xl"><span class="text-pink-500 font-bold">M</span>y Posts</h1>
                            <div class="h-1 w-20 bg-pink-500 rounded"></div>
                            <br>
                            <div class="text-gray-600" >
                                <p class="text-md">Here is a list of the HPLC data you have registered.</p>
                ...
                <div class="w-1/3">
                    <div class="">
                        ...
                        <div class="">
                            <h1 class="ml-2 text-lg text-pink-500">No:{{ $post->id }}</h1>
                            <div class="ml-2 mr-2">
                                <form action="{{ route('hplcUpdateData', ['hplc_result' => $post->id]) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Really Refresh?');">
                                    @csrf
                                    @method('PUT')
